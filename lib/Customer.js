...
Customer.prototype.read_posts = function (type, n, aud, on_fin, on_db_err) {
  ...
  var sql     = " \
     ...
     FROM   posts LEFT OUTER JOIN screen_names ON (posts.author_id = screen_names.id) \
     WHERE  pub_id = $1 \
  ";
...
Customer.prototype.update_screen_name = function ( name, new_vals, on_fin, on_err ) {
  var me      = this;
