  ...
  pg.show_default_owner(function (owner) {
    ...
    db.run_and_then(function (meta) {
      ...
      db.run_and_then(function (meta) {
        ...
        c_db.q("CREATE TABLE IF NOT EXISTS posts ( \
               id              varchar(" + pg.id_size       + ") NOT NULL UNIQUE, \
               screen_name_id  varchar(" + Customer.id_size + ") NOT NULL UNIQUE, \
        ...
        c_db.q('INSERT INTO homepages (screen_name_id, settings, details) VALUES ($1, $2, $3);', [screen_name_id, '', '']);
...
Customer.prototype.read_homepage = function (name, on_fin, on_err) {
  ...
  pg.id_select( '/' + me.data.db_name, 'homepages', 'screen_name_id', id, on_fin, on_err);
};
