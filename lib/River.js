...
River.prototype.error = function (msg) {
  this.emit('error', msg);
  return this;
};

River.prototype.emit = function (name, msg) {
  var e = this.events[name] || [];
  var me = this, i = 0, l = e.length;

  if ( l === 0 && name.indexOf('err') > -1 ) {
    if (_.isString(msg))
      throw new Error(msg);
    ...
    throw new Error('No error handlers defined for: ' + name);
  }
