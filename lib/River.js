...
River.validate_event_name = function (cat, r, name) {
  if (_.contains(River.valid_event_names[cat], name))
    return r;
...
River.prototype.validate_event_name = function (name) {
  River.validate_event_name('river', this, name);
  return this;
};
...
River.prototype.on_job = function (name, func) {
  River.validate_event_name('job', this, name);
...
River.prototype.emit = function (name, msg, job) {
  ...
  if (!_.contains(River.valid_event_names['river'], name)) {
