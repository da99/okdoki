...
Member.prototype.create = function (func) {
  ...
  pg_client.query('CREATE DATABASE "customer-' + customer_id + '" ENCODING = \'UTF8\' LC_COLLATE = \'en_US.UTF-8\' LC_CTYPE = \'en_US.UTF-8\';', [], function (err, meta) {

    pg_client.query('BEGIN;');
    pg_client.query('INSERT INTO customers (id, passphrase_hash) VALUES ($1, $2);', [customer_id, mask_id]);
    pg_client.query('INSERT INTO screen_names (id, customer_id, screen_name) VALUES ($1, $2, $3);', [mask_id, customer_id, me.new_values.mask_name], function (err, meta) {
      ...
      pg_client.query('COMMIT;', [], function () {
