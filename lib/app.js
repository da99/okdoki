...
app.post('/qa/:name', function (req, resp, next) {
  var n = req.params.name;
  Customer.read_by_screen_name(n, function (c) {
    ...
    c.create_question(vals, function (record) {
      write_json(resp, {success: true, msg: "Question has been saved.", rows: [record.data]});
    }, function (errors) {
