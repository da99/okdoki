...
app.get( '/', function (req, resp) {
  resp.render('index', {view_name: 'index', title: "OkDoki.com", token: req.session._csrf});
});

app.get( '/info/:name', function (req, resp) {
  resp.render('info', {view_name: 'info', title: req.params.name, token: req.session._csrf, username: req.params.name });
});


app.get( '/chat', function (req, resp) {
  resp.header('CSRF-TOKEN', req.session._csrf);
  resp.render('chat', {view_name: 'chat', title: "Chat", token: req.session._csrf});
});
