...
_.each(['Test', 'Site', 'Chat', 'Posts', 'Screen_Names'], function (name) {
...
OK.put('/screen_names/:name');
OK.post('/undo/trash/screen_name/:name');
OK.post('/trash/screen_name/:name');
