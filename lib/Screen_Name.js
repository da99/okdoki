...
var Client      = require('okdoki/lib/POSTGRESQL').Client;
...
S.prototype.create = function () {
  ...
  pg.run_and_on_finish(function (err, meta) {
    ...
    me.customer.push_screen_name_row(meta.rows[0]);
    me.river.finish(me);
  });
};
...
S.prototype.edit_at_passphrase = function (v) {
...
S.prototype.edit_bot_passphrase = function (v) {
...
S.prototype.update_screen_name = function ( name, new_vals, river ) {
  var me      = this;
