...
Contact.create = function (c, flow) {
}

Contact.read_real_friends = function () {
  var o_into_contacts = [];
  var c_into_owner    = [];
  var o_menu          = {};
  var c_menu          = {};
...
Contact.read = function (screen_name_id, flow) {
  var me = this;
  var db = new pg.query();
...
Contact.read_real_contacts = function (flow) {
  var me  = this;
  var db  = new pg.query();
  var sql = "\
SELECT \
