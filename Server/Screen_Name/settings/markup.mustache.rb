...
<html lang="en">
  <head>
    <title>Settings for: {{user.screen_name}}</title>
...
Go chose some bots from the list: <a href="/bots">/bots</a>
</div>{{/bots}}
    ...
    <script src="/Screen_Name/settings/script.js?{{file_stamp}}" type="text/javascript"></script>
  </body>
</html>
